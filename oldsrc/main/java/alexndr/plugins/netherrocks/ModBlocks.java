...
public class ModBlocks 
{
	...
	public static SimpleBlock malachite_block = 
			new SimpleBlock("malachite_block", Netherrocks.plugin, Material.IRON,
			ContentCategories.Block.GENERAL).setStepSound(SoundType.METAL);
	...
	public static void configureBlocks() 
	{
		...
		if (Settings.netherFurnace.isEnabled()) {
			...
			nether_furnace_lit.setConfigEntry(Settings.netherFurnace)
				...
				.setItemToDrop(nether_furnace.getItemToDrop());
			NetherFurnaceBlock.setUnlit_furnace(nether_furnace);
			NetherFurnaceBlock.setLit_furnace(nether_furnace_lit);
		}
	} // end configureBlocks()
