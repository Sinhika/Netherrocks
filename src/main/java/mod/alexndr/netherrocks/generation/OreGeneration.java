	...
	public static void setupNetherOreGen() {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			if (NetherrocksConfig.enableArgoniteOre) {
				biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, Biome.createDecoratedFeature(Feature.ORE,
						new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NETHERRACK,
								ModBlocks.argonite_ore.get().getDefaultState(), NetherrocksConfig.argonite_veinsize),
						Placement.COUNT_RANGE, NetherrocksConfig.argonite_cfg));
			}
			if (NetherrocksConfig.enableAshstoneOre) {
				biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, Biome.createDecoratedFeature(Feature.ORE,
						new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NETHERRACK,
								ModBlocks.ashstone_ore.get().getDefaultState(), NetherrocksConfig.ashstone_veinsize),
			...
			if (NetherrocksConfig.enableFyriteOre) {
				biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, Biome.createDecoratedFeature(Feature.ORE,
						new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NETHERRACK,
								ModBlocks.fyrite_ore.get().getDefaultState(), NetherrocksConfig.fyrite_veinsize),
						Placement.COUNT_RANGE, NetherrocksConfig.fyrite_cfg));
			}
			if (NetherrocksConfig.enableMalachiteOre) {
				biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, Biome.createDecoratedFeature(Feature.ORE,
						new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NETHERRACK,
								ModBlocks.malachite_ore.get().getDefaultState(), NetherrocksConfig.malachite_veinsize),
			...
			if (NetherrocksConfig.enableIllumeniteOre) {
				Biome.createDecoratedFeature(ILLUMENITE_FEATURE, IFeatureConfig.NO_FEATURE_CONFIG,
						Placement.LIGHT_GEM_CHANCE, new FrequencyConfig(NetherrocksConfig.illumenite_veinsize));
