...
{
    public final NetherFurnaceTileEntity tileEntity;
    ...
    {
        super(ModContainers.NETHER_FURNACE.get(), windowId);
    ...
    public boolean canInteractWith(@Nonnull final PlayerEntity player) {
        return isWithinUsableDistance(canInteractWithCallable, player, ModBlocks.nether_furnace.get());
    }
