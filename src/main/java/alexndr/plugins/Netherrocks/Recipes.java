...
public class Recipes {
	...
	public static void doRecipes()
	{
		...
		// Furnace Recipes
		GameRegistry.addSmelting(Content.fyrite_ore, new ItemStack(
				Content.fyrite_ingot, 1, 0), 0.8F);
		GameRegistry.addSmelting(Content.malachite_ore, new ItemStack(
				Content.malachite_ingot, 1, 0), 0.5F);
		GameRegistry.addSmelting(Content.ashstone_ore, new ItemStack(
				Content.ashstone_gem, 1, 0), 0.8F);
		GameRegistry.addSmelting(Content.illumenite_ore, new ItemStack(
				Content.illumenite_ingot, 1, 0), 0.8F);
		GameRegistry.addSmelting(Content.argonite_ore, new ItemStack(
				Content.argonite_ingot, 1, 0), 0.7F);
		GameRegistry.addSmelting(Content.dragonstone_ore, new ItemStack(
				Content.dragonstone_gem, 1, 0), 1.0F);
	} // end doRecipes()
